...
<head>
    <title>Madrid.rb: Terracismo.rb</title> 
...
<link rel="alternate" type="application/atom+xml" title="Terracismo.rb: Recent changes" href="http://madridrb.jottit.com/terracismo.rb?m=history.atom" />
...
<div id="header">
    ...
    <div id="menu">
        ...
        <a href="http://madridrb.jottit.com/site/signin?return_to=Terracismo.rb">sign in</a>
...
<p><strong>Lugar:</strong> Terraza Valle Hermoso<br />
<strong>Hora:</strong> 20:00h</p>

<p>Siguiendo la tradición, en periodos estivales tratamos de soportar los rigores del clima de la capital en una terraza, con una cerveza (o refresco) y en compañía de lo más granado del rubismo madrileño (los que no han huido de Madrid, vaya).</p>



<div id="dateline">

    changed <span id="datestr">February 18, 2011</span>

    
    <a accesskey="d" href="http://madridrb.jottit.com/terracismo.rb?m=delete">delete</a>
    
    <a accesskey="h" href="http://madridrb.jottit.com/terracismo.rb?m=history">history</a>
    <a accesskey="e" href="http://madridrb.jottit.com/terracismo.rb?m=edit">edit</a>
...
<ul id="pages">
    ...
    <li><a href="http://madridrb.jottit.com/marzo_2014">Marzo 2014</a></li>
    ...
    <li><strong>Terracismo.rb</strong></li>
...
<script type="text/javascript">
    Page.name = "Terracismo.rb";
    Page.url = "http://madridrb.jottit.com/terracismo.rb";
